...
<div class="container-fluid">
    <form action="" id="registration">
        ...
        <h3 class="text-center">Criar nova conta
        ...
        <div class="row  align-items-center h-100">
            ...
            <div class="col-lg-5 border-right">
                ...
                <div class="form-group">
                    <label for="" class="control-label">Ultimo nome</label>
            ...
            <div class="col-lg-7">
                <div class="form-group">
                    <label for="" class="control-label">Endereço por padrão</label>
                ...
                <div class="form-group d-flex justify-content-between">
                    <a href="javascript:void()" id="login-show">Já possui uma conta</a>
                    <button class="btn btn-primary btn-flat">Registar</button>
                </div>
            </div>
        </div>
    </form>
